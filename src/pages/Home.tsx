                         ...
                         <div className="flex w-full items-center justify-between mt-4 pt-3 border-t border-border/30">
                            <div className="flex items-center">
                             {!doseStatus && isOverdue && (
                               <Badge className="bg-destructive text-destructive-foreground border-destructive text-[10px] font-bold px-2 py-0.5 m-0 inline-flex items-center justify-center gap-1">
