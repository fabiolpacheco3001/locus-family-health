  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "h-9 w-9 text-center text-sm p-0 relative [&:has([data-selected][data-range-end])]:rounded-r-md [&:has([data-selected][data-outside])]:bg-accent/50 [&:has([data-selected])]:bg-accent first:[&:has([data-selected])]:rounded-l-md last:[&:has([data-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
